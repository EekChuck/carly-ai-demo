  ...
  return (
    <section style={{
      ...
      <div style={{
        ...
        <Image
          src="https://images.unsplash.com/photo-1568366838225-b9b33d41c1ac?auto=format&fit=crop&w=2000&q=80"
        ...
        <div style={{
          position: 'absolute',
          inset: 0,
          background: `linear-gradient(to right, rgba(var(--primary-rgb), 0.92), rgba(var(--secondary-rgb), 0.92))`
        }}/>
      </div>
      ...
      <div style={{
        ...
        Photo by <a
          href="https://unsplash.com/@whitebin"
          target="_blank"
