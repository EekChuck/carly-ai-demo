...
function ServiceCard({ title, purpose, values }: ServiceCardProps) {
  return (
    <div className="bg-white rounded-xl shadow-lg p-8 transition-transform hover:-translate-y-1 hover:shadow-xl">
      <h3 className="text-2xl font-bold text-gray-800 mb-4">{title}</h3>
      <p className="text-lg text-gray-600 mb-6">{purpose}</p>
      <div className="bg-gray-50 p-4 rounded-lg">
        <h4 className="text-primary font-semibold mb-2">Value Delivered:</h4>
