  ...
  return (
    <section style={{
      ...
      <div style={{
        ...
        <Image
          src="https://images.unsplash.com/photo-1706800882698-0da7a7d3d3a0?auto=format&fit=crop&w=2000&q=80"
          alt="Salesman figuring the car expense with customer"
          fill
          style={{
            objectFit: 'cover',
            opacity: 0.6
      ...
      <div style={{
        ...
        Photo by <a
          href="https://unsplash.com/@jmckinven"
          target="_blank"
